...
@SupportedAnnotationTypes("SPIService")
public class SPIServiceProcessor extends AbstractProcessor {
    ...
    public ImmutableSet<String> getSupportedAnnotationTypes() {
        return ImmutableSet.of(SPIService.class.getName());
    }
    ...
    private void processAnnotations(Set<? extends TypeElement> annotations,
        ...
        Set<? extends Element> elements = roundEnv.getElementsAnnotatedWith(SPIService.class);
        ...
        for (Element e : elements) {
            ...
            AnnotationMirror annotationMirror = getAnnotationMirror(e, SPIService.class).get();
